...
----------
## 预训练模型应用 inference.py 原始唇音匹配
1. download the face detection model checkpoint:
    ```
    !wget "https://www.adrianbulat.com/downloads/python-fan/s3fd-619a316812.pth" -O "face_detection/detection/sfd/s3fd.pth"
    ```
2. download the pretrained model checkpoint:
    ```
    !wget "https://iiitaphyd-my.sharepoint.com/:u:/g/personal/radrabha_m_research_iiit_ac_in/Eb3LEzbfuKlJiR600lQWRxgBIY27JZg80f7V9jtMfbNDaQ?e=TBFBVW" -O "checkpoints/wave2lip.pth"
    !wget "https://iiitaphyd-my.sharepoint.com/:u:/g/personal/radrabha_m_research_iiit_ac_in/EdjI7bZlgApMqsVoEUUXpLsBxqXbn5z8VTmoxp55YNDcIA?e=n9ljGW" -O "checkpoints/wave2lip_gan.pth"
    ```
3. execute through python:
    ```
...
4. 效果举例：
 - 狗唇音匹配效果：
 <video src="example/dog_lip_match.mp4" controls="controls" width="500" height="300">您的浏览器不支持播放该视频！</video>
 - 人唇音匹配效果：
 <video src="example/aobama_lip_match.mp4" controls="controls" width="500" height="300">您的浏览器不支持播放该视频！</video>
----------

----------
## 预训练模型应用 inference3.py 补充脸部像素点位置识别，解决人脸合并时的像素色差
1. download model checkpoint:
    ```
    !wget "https://www.adrianbulat.com/downloads/python-fan/s3fd-619a316812.pth" -O "face_detection/detection/sfd/s3fd.pth"
    !wget "https://drive.google.com/file/d/154JgKpzCPW82qINcVieuPH3fZ2e0P812/view" -O "checkpoints/face_segmentation.pth"
    ```
2. download the pretrained model checkpoint:
    ```
    !wget "https://iiitaphyd-my.sharepoint.com/:u:/g/personal/radrabha_m_research_iiit_ac_in/Eb3LEzbfuKlJiR600lQWRxgBIY27JZg80f7V9jtMfbNDaQ?e=TBFBVW" -O "checkpoints/wave2lip.pth"
...
1. download model checkpoint:
    ```
    !wget "https://www.adrianbulat.com/downloads/python-fan/s3fd-619a316812.pth" -O "face_detection/detection/sfd/s3fd.pth"
    !wget "https://github.com/TencentARC/GFPGAN/releases/download/v1.3.0/GFPGANv1.3.pth" -O "checkpoints/GFPGANv1.3.pth
    !wget "https://drive.google.com/file/d/154JgKpzCPW82qINcVieuPH3fZ2e0P812/view" -O "checkpoints/face_segmentation.pth"
    ...
    !wget "https://github.com/xinntao/Real-ESRGAN/releases/download/v0.2.1/RealESRGAN_x2plus.pt" -O "site-packages/weights/RealESRGAN_x2plus.pt"
    ```
2. download the pretrained model checkpoint:
    ```
    !wget "https://iiitaphyd-my.sharepoint.com/:u:/g/personal/radrabha_m_research_iiit_ac_in/Eb3LEzbfuKlJiR600lQWRxgBIY27JZg80f7V9jtMfbNDaQ?e=TBFBVW" -O "checkpoints/wave2lip.pth"
...
4. 效果举例：
 - 狗唇音匹配效果：
 <video src="example/dog_lip_match_makeup.mp4" controls="controls" width="500" height="300">您的浏览器不支持播放该视频！</video>
 - 人唇音匹配效果：
 <video src="https://gitee.com/sparkle__code__guy/wave2lip/blob/master/example/aobama_lip_match.mp4" controls="controls" width="500" height="300">您的浏览器不支持播放该视频！</video>
----------
